        ...
        switch sections[indexPath.section] {
            case .titleWithDescription:
                ...
                if indexPath.section == 3 {
                    ...
                    titleWithDescriptionCell.bodyLabel.text = user?.userData?.about
                }
                if indexPath.section == 4 {
                    titleWithDescriptionCell.titleLabel.text = "Dealbreakers"
                    titleWithDescriptionCell.bodyLabel.text = user?.userData?.dealBreakers
                }
            ...
            case .profileImages:
                ...
                let url = user?.userImages?.imageURLs
                for u in url! {
